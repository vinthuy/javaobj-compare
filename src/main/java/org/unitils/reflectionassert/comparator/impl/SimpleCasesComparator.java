...
public class SimpleCasesComparator implements Comparator {
    ...
    private Class[] uniqueCasesClazz = new Class[]
    ...
    public Difference compare(Object left, Object right, boolean onlyFirstDifference, ReflectionComparator reflectionComparator) {
        ...
        if (left.getClass().getName().startsWith("java.lang") || right.getClass().getName().startsWith("java.lang")) {
            ...
            // check again  if left value with toString()
            if (isArrayClass(left.getClass()) && isArrayClass(right.getClass())) {
    ...
    private boolean isArrayClass(Class a) {
        for (Class c : uniqueCasesClazz) {
            if (c == a) {
                return true;
            }
        }
