 ...
 * @author Filip Neven
 */
public class LenientOrderCollectionComparator implements org.unitils.reflectionassert.comparator.Comparator {
    ...
    public Difference compare(Object left, Object right, boolean onlyFirstDifference, ReflectionComparator reflectionComparator) {
        ...
        //boolean isEqual = isEqualV2(leftList,rightList,reflectionComparator);
        if (isEqual) {
            // found a match
            return null;
        }
    ...
    protected boolean isEqualV2(ArrayList<Object> leftList, ArrayList<Object> rightList, ReflectionComparator reflectionComparator){
        if(leftList.size()!=rightList.size()){
            return false;
        }
        int listSize = leftList.size();
        int rightSize = listSize;

        LAB:for(int l=0;l<listSize;l++){
            for(int r=0;r<rightSize;r++){
                Object leftObject = leftList.get(l);
                Object rightObject = rightList.get(r);
                Difference difference = reflectionComparator.getDifference(leftObject,rightObject);
    ...
    protected boolean isEqualTest(List<String> leftList, List<String> rightList){
        if(leftList.size()!=rightList.size()){
            return false;
        }
        int listSize = leftList.size();
    ...
    public static void main(String[] args){
        ...
        List<String> a =  getList(new String[]{"b","a","e"});
        List<String> b =  getList(new String[]{"e","b","a"});
        System.out.println(new LenientOrderCollectionComparator().isEqualTest(a,b));
    }
    ...
    protected void removeMatchingIndexes(ArrayList<Integer> leftIndexes, ArrayList<Integer> rightIndexes, UnorderedCollectionDifference difference) {
        ...
        while (rightIterator.hasNext()) {
            ...
            boolean rightItemDeleted = false;
